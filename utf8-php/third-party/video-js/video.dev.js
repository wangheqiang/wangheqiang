 ...
 * @param  {String}   type Type.php of event to bind to.
 ...
 * @param  {String=}   type Type.php of listener to remove. Don't include to remove all events from element.
 ...
 * @param  {String} type Type.php of event to clean up
 * @private
 */
 ...
 * @param  {String} event Type.php of event to trigger
 * @private
 */
...
vjs.Html5.canPlaySource = function(srcObj){
  ...
  // TODO: Check Type.php
  // If no Type.php, check ext
  // Check Media Type.php
};
